...
This library is hosted in the [Maven Central Repositoy](https://maven-badges.herokuapp.com/maven-central/net.markenwerk/utils-mail-dkim). You can use it with the following coordinates:
