...
[![Dependency Status](https://www.versioneye.com/user/projects/562bcd8b36d0ab0019001131/badge.svg?style=flat)](https://www.versioneye.com/user/projects/562bcd8b36d0ab0019001131)
...
This library is hosted in the [Maven Central Repositoy](http://search.maven.org/#artifactdetails|net.markenwerk|utils-mail-dkim|1.0.2|jar). You can use it with the following coordinates:
...
Consult the [usage description](#usage) and [Javadoc](http://markenwerk.github.io/java-utils-mail-dkim/javadoc/1.0.2/index.html) for further information.
...
[DkimAcceptanceException]: http://markenwerk.github.io/java-utils-mail-dkim/javadoc/1.0.2/index.html?net/markenwerk/utils/mail/dkim/DkimAcceptanceException.html
[DkimMessage]: http://markenwerk.github.io/java-utils-mail-dkim/javadoc/1.0.2/index.html?net/markenwerk/utils/mail/dkim/DkimMessage.html
[DkimSigner]: http://markenwerk.github.io/java-utils-mail-dkim/javadoc/1.0.2/index.html?net/markenwerk/utils/mail/dkim/DkimSigner.html
[DomainKeyUtil]: http://markenwerk.github.io/java-utils-mail-dkim/javadoc/1.0.2/index.html?net/markenwerk/utils/mail/dkim/DomainKeyUtil.html
